...
const isDarkTheme = _theme === 'dark' ? true : _theme === 'light' ? false : Device.isUsingDarkAppearance();
const padding = 8;
...
const backgroundColor = isDarkTheme ? darkBackgroundColor : lightBackgroundColor;
...
function circleProgressbar(deg, label, theme) { 
  ...
  // draw trail line
  canvas.strokeEllipse(new Rect(lineWidth / 2, lineWidth / 2, diameter, diameter));
